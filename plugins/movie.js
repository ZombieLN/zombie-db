...
async (conn, mek, m, {
  ...
  try {
    ...
    let imageBuffer;
    try {
      const res = await axios.get('https://files.catbox.moe/6qxk37.jpg', {
    ...
    if (config.BUTTON === "true") {
      ...
      return await conn.sendMessage(from, {
        image: imageBuffer || { url: 'https://files.catbox.moe/6qxk37.jpg' },
        caption,
...
cmd({
    ...
    try {
        ...
        const episodes = sadas.data.episodes;
        const showimg = sadas.data.mainImage || "https://files.catbox.moe/6qxk37.jpg";
